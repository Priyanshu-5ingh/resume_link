...
const saluetewordcontainer= document.querySelector(".saluetewordcontainer")
const salueteImgcontainer= document.querySelector(".salueteImgcontainer")
const Authorname= document.querySelector(".name")
const workcontainer= document.querySelectorAll(".workcontainer")
...
window.addEventListener("scroll",()=>{
    ...
    saluetewordcontainer.style.transform=`translateY(${offsetY*0.1}px)`
    salueteImgcontainer.style.transform=`translate(${offsetY*0.4}px,${offsetY*0.7}px)`
    ...
    workname[0].style.transform=`translateX(calc(200vh - ${offsetY}px))`
    workname[1].style.transform=`translateX(calc(-300vh + ${offsetY}px))`
    projecttitle.style.transform=`translateY(calc(400vh - ${offsetY}px))`
    phone[0].style.transform=`translateX(calc(555vh - ${offsetY}px))`
    phone[1].style.transform=`translateX(calc(650vh - ${offsetY}px))`
    laptop.style.transform=`translateX(calc(-435vh + ${offsetY}px))`
